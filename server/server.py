...
def ultra_send_controller():
    ...
    print('ultra addr: '+str(ultra_ADDR))
    while 1:
...
def run():
    ...
    while True: 
        ...
        if not data:
            ...
            print('pos input: '+str(pos_input))
            if pos_input < 16:
                pos_input+=1
            servo.hand_pos(pos_input,data)
        elif 'in' == data:
            print('pos input: '+str(pos_input))
            if pos_input > 1:
                pos_input-=1
...
if __name__ == '__main__':
    ...
    while  1:
        try:
            ...
            s.close()
            print('ipaddr_check: '+str(ipaddr_check))
        except:
        ...
        try:
            ...
            fpv=FPV.FPV() # TODO: is this needed her since it is init in fpv_thread?
